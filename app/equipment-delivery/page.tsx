    ...
    <Layout>
      <div className="max-w-2xl mx-auto space-y-6" dir="rtl">
        ...
        <p className="text-sm text-[rgba(234,240,255,0.65)]">
          ...
          الرئيسي ويُنشأ عهدة بأسعار ثابتة لحظة التسليم (Snapshot) — لو تغيّر السعر لاحقاً لا يتأثر هذا المندوب.
          التقسيط على 3 دورات مع منع خصم مزدوج لنفس القسط (Idempotency). تأكد أن الاسم يطابق ورقة المناديب حرفياً.
        </p>
