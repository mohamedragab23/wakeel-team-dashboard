 ...
 *
 * Uses ONLY SRS014_PC_QA_ synthetic identities.
...
const ACTOR = { code: 'SRS014_PC_QA', name: 'SRS014 Phase C Enablement QA' };

const RIDER_PAID = '999014811';
const RIDER_UNPAID = '999014812';
const RIDER_FAIL = '999014813';
...
async function main() {
  console.log('=== Phase C Controlled Enablement + Synthetic Production QA ===\n');
  console.log(`BASE=${BASE}`);
  console.log(`Commit probe will use live Production APIs + shared Sheets\n`);

  const adminToken = mint('admin', 'SRS014_PC_QA_ADMIN');
